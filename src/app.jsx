...
const SLIDES = [
  {
    ...
    body: 'Your personal gym tracker. Log workouts, track progress, and build better habits — all from your phone.',
  },
  {
    ...
    body: 'Create workout templates for your regular sessions — push day, pull day, legs — then start them in one tap from the home screen.',
  },
  {
